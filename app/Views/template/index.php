...
<head>
  ...
  <!-- fontawesome -->
  <link rel="stylesheet" href="<?php base_url(); ?>/assets/fontawesome/css/all.min">
   <!-- SweetAlert2 -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php base_url(); ?>/assets/dist/img/motor.png" alt="AdminLTELogo" height="60" width="60">
  </div>
...
<?php echo $this->include('template/sidebar'); ?>
  ...
  <footer class="main-footer">
    <strong><a href="#">Samsul Sodung</a>.</strong>
    <div class="float-right d-none d-sm-inline-block">
      <b>Ini adalah aplilasi sederhana yang di buat oleh SAMSUL SODUNG</b>
    </div>
  </footer>
  <!-- /.control-sidebar -->
</div>
